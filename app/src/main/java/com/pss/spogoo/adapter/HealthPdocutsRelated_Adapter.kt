...
class HealthPdocutsRelated_Adapter(
    var context: Context,
    val userList: ArrayList<HealthProductsResponse>
) :
    RecyclerView.Adapter<HealthPdocutsRelated_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): HealthPdocutsRelated_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: HealthPdocutsRelated_Adapter.ViewHolder,
        position: Int
    ) {
