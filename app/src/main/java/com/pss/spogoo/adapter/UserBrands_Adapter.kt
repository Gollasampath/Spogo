...
import com.pss.spogoo.models.BrandsProductsDeResponse
...
class UserBrands_Adapter(
    context: Context,
    arrayListImage: ArrayList<BrandsProductsDeResponse>
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (offerprice == null || offerprice.equals("")) {
            ...
            var regularprice = arrayListImage.get(position).sales_price.toString()
        ...
        Observable.create(ObservableOnSubscribe<MutableList<CartItem>> {
            ...
            holder.addcart_btn!!.setOnClickListener { view ->
                ...
                val item = CartItem(
                    arrayListImage.get(position).brands_id,
