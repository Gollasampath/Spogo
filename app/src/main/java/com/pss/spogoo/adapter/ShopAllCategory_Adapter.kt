...
class ShopAllCategory_Adapter(
    var context: Context,
    val userList: ArrayList<ShopAllCategoryResponse>
) :
    RecyclerView.Adapter<ShopAllCategory_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ShopAllCategory_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ShopAllCategory_Adapter.ViewHolder, position: Int) {
