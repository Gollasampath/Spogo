...
import com.pss.spogoo.models.ApparelsProductResponse
import java.text.DecimalFormat

class ApprealsRelated_Adapter(
    var context: Context,
    val userList: ArrayList<ApparelsProductResponse>
) :
    RecyclerView.Adapter<ApprealsRelated_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ApprealsRelated_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: ApprealsRelated_Adapter.ViewHolder,
        position: Int
    ) {
