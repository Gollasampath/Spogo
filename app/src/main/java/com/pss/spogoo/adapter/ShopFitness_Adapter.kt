...
import com.pss.spogoo.models.FitnessExcerseResponse
import java.text.DecimalFormat

class ShopFitness_Adapter(var context: Context, val userList: ArrayList<FitnessExcerseResponse>) :
    RecyclerView.Adapter<ShopFitness_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ShopFitness_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ShopFitness_Adapter.ViewHolder, position: Int) {
        ...
        holder.mainprice.text = "\u20B9 " + userList.get(position).price.toString()
