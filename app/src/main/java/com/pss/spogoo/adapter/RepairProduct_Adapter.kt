...
class RepairProduct_Adapter(
    context: Context,
    arrayListImage: ArrayList<RepairsProductsResponse>
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        Observable.create(ObservableOnSubscribe<MutableList<CartItem>> {
            ...
            holder.addcart_btn!!.setOnClickListener { view ->
                ...
                val item = CartItem(
                    arrayListImage.get(position).repairs_id,
                    arrayListImage.get(position).product_name,
                    arrayListImage.get(position).product_image,
                    arrayListImage.get(position).regular_price.toString(),
                    arrayListImage.get(position).special_price.toString(),
