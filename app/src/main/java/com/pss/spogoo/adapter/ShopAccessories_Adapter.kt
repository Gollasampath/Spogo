...
import com.pss.spogoo.models.AccessoriesProductResponse
import java.text.DecimalFormat

class ShopAccessories_Adapter(
    var context: Context,
    val userList: ArrayList<AccessoriesProductResponse>
) :
    RecyclerView.Adapter<ShopAccessories_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ShopAccessories_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ShopAccessories_Adapter.ViewHolder, position: Int) {


        holder.repairrecenttext.text = userList.get(position).name
        ...
        if (offerprice == null || offerprice.equals("")) {
            ...
            holder.offerprice.text = "\u20B9 " + userList.get(position).sales_price
