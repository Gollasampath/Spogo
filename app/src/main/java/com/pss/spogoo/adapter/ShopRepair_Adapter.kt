...
import com.pss.spogoo.models.RecentProdcutsResponse
import java.text.DecimalFormat

class ShopRepair_Adapter(var context: Context, val userList: ArrayList<RecentProdcutsResponse>) :
    RecyclerView.Adapter<ShopRepair_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ShopRepair_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ShopRepair_Adapter.ViewHolder, position: Int) {
