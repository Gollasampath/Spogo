...
class ElectronicsRelated_Adapter(
    var context: Context,
    val userList: ArrayList<ElectronicsProductResponse>
) :
    RecyclerView.Adapter<ElectronicsRelated_Adapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ElectronicsRelated_Adapter.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: ElectronicsRelated_Adapter.ViewHolder,
        position: Int
    ) {
